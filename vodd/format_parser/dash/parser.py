...
class Parser:
    ...
    @classmethod
    def from_string(cls, manifest_as_string: str, url: str = None) -> MPD:
        ...
        if encoding:
            return MPD(root, url, encoding=encoding[0].groups()[0])
        return MPD(root, url)

    @classmethod
    def from_file(cls, manifest_file_name: str, url: str = None) -> MPD:
        """
